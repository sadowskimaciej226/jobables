...
class JobOfferFetcherErrorIntegrationTest {
  ...
  JobOfferFetcher jobOfferFetcher = new JobOfferFetcherIntegrationTestConfig().remoteJobOfferClient(wireMockServer.getPort());
    @Test
    void should_return_response_500_when_fault_connection_reset_by_peer(){
        //given
        ...
        //when
        Throwable throwable = catchThrowable(() -> jobOfferFetcher.fetchAllOffers());
    ...
    @Test
    void should_return_response_500_when_response_delay_is_5000_ms_and_client_has_1000ms_read_timeout() {
        // given
        wireMockServer.stubFor(WireMock.get("/offers")
                .willReturn(WireMock.aResponse()
                        .withStatus(HttpStatus.SC_OK)
